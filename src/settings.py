...
class Settings(BaseSettings):
    ...
    prompt: str = Field(
        default=(
            ...
            "If the person is not at rest (e.g., taking off a sweater, scratching head, not facing their monitors, etc.) or their hands are NOT on the keyboard / typing, IGNORE the frame by responding with an Error.\n\n"
